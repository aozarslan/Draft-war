...
import { BODIES, Pixels, REST, type BodyId, type Pose } from "./sprite-bodies";
...
function buildSheet(body: BodyId): Buffer {
...
for (const archetype of DRAWN_ARCHETYPES) {
  const png = buildSheet(archetype as BodyId);
